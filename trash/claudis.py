...
PAPERS_PER_EMAIL = 70
DOWNLOAD_DIR = 'clauds'
REQUIRED_CSV = 'claudreq.csv'
AVAILABLE_CSV = 'claudeavail.csv'
TEMP_SUFFIX = '.tmp'
...
def load_downloaded_dois():
    ...
    # From existing files in download directory
...
def main():
    ...
    log("="*60)
    log("Paper Download Manager - installer.py")
    log("="*60)
